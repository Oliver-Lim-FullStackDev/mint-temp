  ...
  const carrouselItems: CarrouselItem[] = [
    {
      ...
      gameLink: paths.casino.details(CAROUSEL_GAME_IDS.octogame),
    },
    {
      id: '2',
      ...
      gameLink: paths.casino.details(CAROUSEL_GAME_IDS.pengwin),
    },
    {
      id: '3',
      ...
      gameLink: paths.casino.details(CAROUSEL_GAME_IDS.mintySpins),
    },
  ];
