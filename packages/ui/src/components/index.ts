/**
 * ------------------------------------------
 * MUI Component Re-Exports (Tree-shakable)
 * Version: @mui/material v7.2.0 (latest stable)
 * ------------------------------------------
 *
 * Explicit per-path re-exports preserve tree-shaking.
 * Import like:
...
export { default as Transitions } from '@mui/material/Zoom';

// MUI Misc
export { default as Slide } from '@mui/material/Slide';
export { iconButtonClasses } from '@mui/material/IconButton';

export type { Theme, CSSObject, Breakpoint } from '@mui/material/styles';
